...
////////////////////////////////////////////////////////////////////////////////// 	
//IO方向设置
#define SCCB_SDA_IN()  {GPIOH->MODER&=~(3<<(8*2));GPIOH->MODER|=0<<8*2;}	//PB3输入模式
#define SCCB_SDA_OUT() {GPIOH->MODER&=~(3<<(8*2));GPIOH->MODER|=1<<8*2;}    //PB3输出模式
//IO操作
...
#define SCCB_READ_SDA    HAL_GPIO_ReadPin(GPIOH,GPIO_PIN_8)     //输入SDA
